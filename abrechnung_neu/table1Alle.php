...
<html>
  <head>
    ...
    <title>Übersicht <?php echo $datab1; ?> <?php echo date("Y"); ?></title>
  </head>
  <body>
    ...
    <div id="head">
      <div id="inHead">
        <h1>Übersicht <br><?php echo $table1; ?> <br> <?php echo date("Y"); ?></h1>
      ...
      <table id="one">
        ...
        <tbody>
          ...
          <?php
            ...
            if ($result1 = $connect->query("SELECT * FROM $datab1Alle ORDER BY id"))
            {
